package com.liquorlogic.supplierservice.controller;

import com.liquorlogic.supplierservice.dto.SupplierDTO;
...
public class SupplierController {
    ...
    public ResponseEntity saveSupplier(@RequestBody Map<String, String> credentials) {
        ...
        try {
            ...
            supplier.setStatus(Status.valueOf(credentials.get("status")));
    ...
    public ResponseEntity<SupplierDTO> getUser(@RequestParam(required = false) Status status,
